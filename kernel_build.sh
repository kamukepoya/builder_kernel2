...
git clone --depth=1 https://github.com/Atom-X-Devs/atom-x-tc-build clang # clang set as Clang Default
...
# Compile
compile(){
tg_post_msg "<b>KucingKernelCompiler:</b><code>Compilation has started</code>"
cd ${KERNEL_ROOTDIR}
